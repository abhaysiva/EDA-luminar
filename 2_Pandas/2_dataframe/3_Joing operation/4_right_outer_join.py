...
# 0  103   Amal     P  23.0  bigdata    1200       aluva
# 1  104  Binoy     U  27.0   python    2333     paravur
# 2  105  Vivek     V  22.0  flutter    4567      kollam
# 3  106    NaN   NaN   NaN  bigdata    1230  karumaloor
# 4  107    NaN   NaN   NaN   python    9123      Mannam

# rigth outer joing:it use for the joing of the commmons and
# show the complete data  values of the right table and left tables values remaining will be null (NaN)