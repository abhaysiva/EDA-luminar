...
# 0  101  Vinay     K   28      NaN     NaN      NaN
# 1  102    Anu     S   24      NaN     NaN      NaN
# 2  103   Amal     P   23  bigdata  1200.0    aluva
# 3  104  Binoy     U   27   python  2333.0  paravur
# 4  105  Vivek     V   22  flutter  4567.0   kollam

# left outer joing:it use for the joing of the commmons and
# show the complete data  values of the left table and rights tables values remaining will be null (NaN)
